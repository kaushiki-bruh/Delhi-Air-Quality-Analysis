...
A comprehensive data analytics project on analyzing Air Quality Index (AQI) data to understand pollution trends, seasonal patterns, and pollutant behavior over time.
...
Records: 1461  
Features: 
- pollutants: PM2.5, PM10, NO2, SO2, CO, O3 levels
- aqi: Air Quality Index (target variable)
- holidays and day of week
